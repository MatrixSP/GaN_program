...
void dma_portx2buff_init(DMA_CHn, void *SADDR, void *DADDR, PTXn_e, DMA_BYTEn, uint32 count, uint32 cfg);

void DMA_count_Init(DMA_CHn CHn, PTXn_e ptxn, uint32 count, uint32 cfg);
