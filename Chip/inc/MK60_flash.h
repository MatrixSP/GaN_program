...
__RAMFUNC    ramint8   flash_erase_sector  (uint16 sectorNo);                                                      //擦除指定flash扇区

__RAMFUNC    ramint8   flash_write         (uint16 sectorNo, uint16 offset, FLASH_WRITE_TYPE data);                          //写入flash操作
__RAMFUNC    ramint8   flash_write_buf     (uint16 sectorNo, uint16 offset, uint16 cnt, uint8 buf[]);              //从缓存区写入flash操作
